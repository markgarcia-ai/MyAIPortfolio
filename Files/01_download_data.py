...
def download_stock_data(symbols, start_date, end_date, data_folder='data2'):
...
if __name__ == "__main__":
    print("===========STEP 1 : DOWLOAD SP500 INFORMATION====================")
    fetch_sp500_data()
    print("===========STEP 2 : DOWLOAD SP500 STOCKS DATA====================")
    csv_file = 'sp500_stocks.csv'
    symbols = get_symbols_from_csv(csv_file)
    start_date = '2024-04-01'  # Example start date
    end_date = '2024-04-27'    # Example end date  
