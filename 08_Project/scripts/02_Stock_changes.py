...
def function2_1():
    ...
    input_csvs = ["sp500_stocks.csv","sp600_stocks.csv"]  # Add your input CSVs here
    folder_paths = ["SP500_data", "SP600_data"]  # Add corresponding folder paths here
    ...
    end_date = "2024-12-20"    # Example end date (YYYY-MM-DD)
